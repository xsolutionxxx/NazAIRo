    ...
    return (
      <div className={cn("relative w-full group", containerClassName)}>
        <label
          htmlFor={inputId}
          className={cn(
            "absolute -top-2 left-3 px-1 bg-surface text-sm text-input capitalize transition-colors",
        ...
        <input
          ...
          className={cn(
            "peer",
            "py-1 px-3 w-full min-w-0 h-14 bg-transparent border-2 border-input-secondary rounded-xl text-base text-input outline-none transition-all hover:border-primary placeholder:text-input-secondary autofill:bg-transparent",
