...
const appButtonVariants = cva(
  "inline-flex justify-center items-center gap-2 lg:gap-2 font-medium text-sm text-foreground outline-accent cursor-pointer transition-all md:hover:scale-103 active:scale-95" +
