...
export default function FlightCard({
    ...
    return (
        <div className="bg-surface rounded-2xl border border-[#D7E2EE] hover:shadow-md transition-shadow overflow-hidden">
            <div className="p-5">
                <div className="flex-col flex sm:flex-row sm:items-center gap-4">
                    <div className="hidden sm:flex flex-col items-center gap-1.5 w-15 shrink-0">
                        <AirlineLogo
                    ...
                    <div className="col-span-2 flex-1 grid grid-cols-[1fr_auto_1fr] items-center gap-2">
                        ...
                        <div className="flex flex-col items-center gap-1 px-2 min-w-[100px]">
                            ...
                            <div className="flex items-center w-full gap-1">
                                <div className="h-0.5 flex-1 bg-[#D7E2EE]" />
                                <ArrowRight
                                    size={14}
                    ...
                    <div className="flex justify-between sm:flex-col sm:items-end gap-3 ml-1.5 lg:ml-4 shrink-0">
                        <div className="text-right">
                            {passengers > 1 && (
                                <p className="text-xs text-foreground-muted">
                ...
                <div className="flex flex-wrap items-center gap-2 mt-4">
                    <span
                        className={cn(
                            ...
                            CABIN_COLORS[flight.cabinClass],
                        )}
                    >
                    ...
                    {flight.amenities.slice(0, 3).map((a) => (
                        <span
                            key={a}
                            className="flex items-center gap-1 text-xs text-foreground-muted px-2.5 py-1 rounded-full bg-background border border-[#D7E2EE]"
                        >
                    ...
                    <button
                        ...
                        className="ml-auto flex items-center gap-1 text-xs text-primary font-medium hover:underline cursor-pointer"
                    >
                        Details
                        <ChevronDown
                            size={13}
                ...
                <div className="border-t border-[#D7E2EE] bg-background px-5 py-4 grid grid-cols-3 gap-4 text-sm">
                    ...
                    <div>
                        ...
                        <p
                            className={cn(
                                "font-medium",
                                lowSeats && "text-accent",
                            )}
                        >
                            {seatsLeft} / {flight.totalSeats}
                        </p>
                    </div>
                    <div>
                        <p className="text-xs text-foreground-muted mb-1">
